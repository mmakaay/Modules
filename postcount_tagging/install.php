...
// adding the custom user field "mod_postcount_tagging" to Phorum.
...
$existing = phorum_api_custom_profile_field_byname("mod_postcount_tagging");
...
phorum_db_update_settings(array("mod_postcount_tagging_installed" => 1));
