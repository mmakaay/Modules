...
class GozerbotUDP
{
     ...
     *
     * @return mixed
     *     NULL in case all went well or an error message string if there
     *     was some problem.
     */
    public function send($msg, $target = NULL)
    {
        ...
        if ($id_max < 0) return
            ...
            'gozerbot UDP packet size of ' .
            GOZERBOT_MAX_UDP_PACKET . ' bytes!';
        ...
        foreach ($msgs as $id => $msg)
        {
            ...
            {
                if (strlen($this->cryptkey) != 16) return
